    ...
    <div class="row">
        <div class="col-12">
            ...
            <ul class="list-unstyled">
                ...
                <li>
                    <dl>
                        <dt> <i class="fas fa-folder text-warning me-1"></i> docs </dt>
                ...
                <li>
                    ...
                    <ul class="list-unstyled ms-4">
                        ...
                        <ul class="list-unstyled ms-4">
                            ...
                            <li>
                                <dl>
                                    <dt><i class="fas fa-folder text-warning me-1"></i> include</dt>
                                    <dd>Contains PHP files for contact form mailing functionality.</dd>
                                </dl>
                            </li>
                            <li>
                                <dl>
