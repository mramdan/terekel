...
<section class="position-relative bg-dark p-0">
    ...
    <div class="tiny-slider dots-white dots-bordered dots-end arrow-bordered arrow-large arrow-round arrow-start-bottom arrow-md-none">
        <div class="tiny-slider-inner h-500 h-sm-700 h-xl-900" data-autoplay="true" data-autoplaytime="7000" data-gutter="0" data-arrow="true" data-dots="true" data-items="1">
            ...
            <!-- Slide 1 START -->
            <div class="h-100 bg-dark-overlay-4 bg-dark" style="background-image:url(<?= base_url() ?>assets/images/bg/curug.jpg); background-position: center center; background-size: cover;">
                    ...
                    <div class="row d-flex h-100">
                        <div class="col-md-8 justify-content-center align-self-center align-items-start">
                            <div class="slider-content text-start">
                                <h5 class="animate__animated animate__fadeInUp animate__delay-1s text-white mb-1 mb-md-4">Curug, Cisaruat Burangrang</h5>
                                <h2 class="display-1 text-white-stroke text-primary-shadow d-block animate__animated animate__fadeInUp animate__delay-2s">Curug</h2>
            ...
            <!-- Slide 2 START -->
            <div class="h-100 bg-dark-overlay-4 bg-white" style="background-image:url(<?= base_url() ?>assets/images/bg/kolam.jpeg); background-position: center center; background-size: cover;">
                <div class="container h-100">
                    <div class="row d-flex h-100">
                        <div class="col-md-8 justify-content-center align-self-center align-items-start">
                            <div class="slider-content text-start">
    ...
    <div class="container">
        <div class="row justify-content-between">
            ...
            <div class="col-lg-6 mb-3">
                <span class="font-alt fw-normal display-6 d-block mb-3">Welcome to our World !</span>
                <h4 class="display-8">Sambutan Ketua Paguyuban Terekel Nekad_</h4>
                <p>We provide digital transformation solutions, enabling companies to make their visions reality. With us at your side, you will find the IT solution to achieve your strategic and financial goals</p>
                <div class="d-md-flex flex-md-row mb-4">
                    <!-- Video START -->
                    <div class="bg-primary-multiply p-4 px-y position-relative overflow-hidden text-center">
                        <a class="btn btn-primary btn-round" data-glightbox data-gallery="video" href="https://youtu.be/n_Cn8eFo7u8"> <i class="fas fa-play"></i></a>
                        <h6 class="mb-0 text-white d-block w-100">Office tour</h6>
                        <p class="mb-0 text-secondary small">In 02:11 min</p>
                        <img class="bg-primary-multiply position-absolute top-50 start-50 translate-middle z-index-n9" src="assets/images/about/07.jpg" alt="">
                    </div>
                    <!-- List items -->
                    <ul class="list-group list-group-borderless list-group-icon-primary-bg mt-5 mt-md-0 ms-0 ms-md-4">
                        ...
                        <li class="list-group-item"><i class="fas fa-check"></i>Secure their enterprise platform for today and the future</li>
                    </ul>
                </div>
            </div>
            <!-- About Right -->
            <div class="col-lg-5">
                <div class="overflow-hidden position-relative">
                    <img class="w-100 rounded" src="<?= base_url() ?>assets/images/terekelnekad.jpg" alt="">
                            ...
                            <svg version="1.1" viewBox="0 0 778 213" xmlns="http://www.w3.org/2000/svg">
                                <defs>
                                    <mask id="white-masking">
                                        ...
                                        <text class="display-3" x="50%" y="45%" text-anchor="middle">
                                            <!-- Change your text below. Also change SVG viewBox size according to your text size -->
                                            <tspan x="50%" y="70%">DEDI SUPRIADI</tspan>
                                        </text>
                                    </mask>
                                </defs>
...
<section class="bg-light position-relative">
    ...
    <figure class="position-absolute start-0 bottom-0 mb-6 ms-5 d-none d-lg-block">
        ...
        <div class="row">
                ...
                <div class="bg-white p-5 line-draw-animation h-100">
                    <div class="line-draw-inner">
                        <div class="text-center">
                            ...
                            <h4 class="my-3"><a href="#">Tempat & Aktrasi</a></h4>
                        </div>
            ...
            <div class="col-md-6 col-lg-4 mb-30">
                <div class="bg-white p-5 line-draw-animation h-100">
                    <div class="line-draw-inner">
                        <div class="text-center">
                            <span class="text-primary display-6"><i class="bi bi-phone"></i></span>
                            <h4 class="my-3"><a href="#">Inspirasi Seru</a></h4>
                        </div>
                ...
                <div class="bg-white p-5 line-draw-animation h-100">
                    <div class="line-draw-inner">
                        <div class="text-center">
                            ...
                            <h4 class="my-3"><a href="#">Rencanakan Perjalanan</a></h4>
                        </div>
    ...
    <div class="container mt-4">
        ...
        <div class="row">
            <div class="col-md-8 mx-auto text-center mb-5">
                <span class="font-alt fw-normal display-8 d-block">Baca berita terbaru !</span>
                <h2 class="display-6">Berita Update</h2>
            </div>
        </div>
        <!-- Portfolio -->
        <div class="row">
            <div class="col-12">
                <div class="tiny-slider arrow-dark arrow-hover">
                    <div class="tiny-slider-inner" data-arrow="true" data-dots="false" data-items-xl="3" data-items-sm="2" data-items-xs="1" data-autoplay="3800">
                        <!-- Card item START -->
                        <div class="item">
                            <div class="card">
                                <div class="position-relative">
                                    <!-- Card Image -->
                                    <img class="card-img-top rounded" src="<?= base_url() ?>assets/images/portfolio/grid/01.jpg" alt="card image">
                                    <!-- Card Overlay -->
                                ...
                                <div class="card-body px-0 mt-n5 position-relative zindex-9">
                                    <span class="display-9 mb-0 mt-2 font-alt fw-normal bg-primary rounded text-white px-2 py-1 ms-3 mb-3 d-inline-block rounded">Furniture</span>
                                    <h4 class="card-title"><a href="#">Unique wooden pieces of furniture</a></h4>
                        ...
                        <div class="item">
                            <div class="card">
                                <div class="position-relative">
                                    <!-- Card Image -->
                                    <img class="card-img-top rounded" src="<?= base_url() ?>assets/images/portfolio/grid/02.jpg" alt="card image">
                                    <!-- Card Overlay -->
                                    <div class="position-absolute top-50 start-50 translate-middle card-element-hover p-0">
                                        <a href="portfolio-detail-1.html" class="btn btn-white btn-sm btn-line">View Project</a>
                                    </div>
                                ...
                                <!-- Card body -->
                                <div class="card-body px-0 mt-n5 position-relative zindex-9">
                                    <p class="display-9 mb-0 mt-2 font-alt fw-normal bg-primary rounded text-white px-2 py-1 ms-3 mb-3 d-inline-block rounded">Website</p>
                                    <h4 class="card-title"><a href="#">Thinking forward in a circle </a></h4>
                                    <p>Passage its ten led hearted removal cordial. Preference any astonished unreserved Mrs</p>
                                </div>
                            </div>
                        </div>
                        <!-- Card item END -->
                        ...
                        <div class="item">
                            <div class="card">
                                <div class="position-relative">
                                    <!-- Card Image -->
                                    <img class="card-img-top rounded" src="<?= base_url() ?>assets/images/portfolio/grid/03.jpg" alt="card image">
                                    <!-- Card Overlay -->
                                    <div class="position-absolute top-50 start-50 translate-middle card-element-hover p-0">
                                        <a href="portfolio-detail-1.html" class="btn btn-white btn-sm btn-line">View Project</a>
                                    </div>
                                ...
                                <!-- Card body -->
                                <div class="card-body px-0 mt-n5 position-relative zindex-9">
                                    <p class="display-9 mb-0 mt-2 font-alt fw-normal bg-primary rounded text-white px-2 py-1 ms-3 mb-3 d-inline-block rounded">Food / Branding</p>
                                    <h4 class="card-title"><a href="#">Art collector and architect</a></h4>
                                    <p>Is drew am hill from me. Valley by oh twenty direct me so. Departure defective arranging rapturous did believe him </p>
                                </div>
                            </div>
                        </div>
                        <!-- Card item END -->
                        ...
                        <div class="item">
                            <div class="card">
                                <div class="position-relative">
                                    <!-- Card Image -->
                                    <img class="card-img-top rounded" src="<?= base_url() ?>assets/images/portfolio/grid/04.jpg" alt="card image">
                                    <!-- Card Overlay -->
                                    <div class="position-absolute top-50 start-50 translate-middle card-element-hover p-0">
                                        <a href="portfolio-detail-1.html" class="btn btn-white btn-sm btn-line">View Project</a>
                                    </div>
                                ...
                                <!-- Card body -->
                                <div class="card-body px-0 mt-n5 position-relative zindex-9">
                                    <p class="display-9 mb-0 mt-2 font-alt fw-normal bg-primary rounded text-white px-2 py-1 ms-3 mb-3 d-inline-block rounded">Branding</p>
                                    <h4 class="card-title"><a href="#">A master of his own craft</a></h4>
                                    <p>Comfort reached gay perhaps chamber his six detract besides add. Moonlight newspaper up its enjoyment.</p>
                                </div>
                            </div>
                        </div>
                        <!-- Card item END -->
                        ...
                        <div class="item">
                            <div class="card">
                                <div class="position-relative">
                                    <!-- Card Image -->
                                    <img class="card-img-top rounded" src="<?= base_url() ?>assets/images/portfolio/grid/05.jpg" alt="card image">
                                    <!-- Card Overlay -->
                                    <div class="position-absolute top-50 start-50 translate-middle card-element-hover p-0">
                                        <a href="portfolio-detail-1.html" class="btn btn-white btn-sm btn-line">View Project</a>
                                    </div>
                                ...
                                <!-- Card body -->
                                <div class="card-body px-0 mt-n5 position-relative zindex-9">
                                    <p class="display-9 mb-0 mt-2 font-alt fw-normal bg-primary rounded text-white px-2 py-1 ms-3 mb-3 d-inline-block rounded">Restaurant</p>
                                    <h4 class="card-title"><a href="#">It’s gonna be extraordinary </a></h4>
                                    <p>Satisfied conveying a dependent contented he gentleman agreeable do be. Warrant private blushes removed</p>
                                </div>
                            </div>
                        </div>
                        <!-- Card item END -->
                        ...
                        <div class="item">
                            <div class="card">
                                <div class="position-relative">
                                    <!-- Card Image -->
                                    <img class="card-img-top rounded" src="<?= base_url() ?>assets/images/portfolio/grid/06.jpg" alt="card image">
                                    <!-- Card Overlay -->
                                    <div class="position-absolute top-50 start-50 translate-middle card-element-hover p-0">
                                        <a href="portfolio-detail-1.html" class="btn btn-white btn-sm btn-line">View Project</a>
                                    </div>
                                ...
                                <!-- Card body -->
                                <div class="card-body px-0 mt-n5 position-relative zindex-9">
                                    <p class="display-9 mb-0 mt-2 font-alt fw-normal bg-primary rounded text-white px-2 py-1 ms-3 mb-3 d-inline-block rounded">Graphics</p>
                                    <h4 class="card-title"><a href="#">A tale of dual addresses</a></h4>
                                    <p>Imprudence attachment him his for sympathize. Large above be to means. Dashwood does provide stronger is. </p>
                                </div>
                            </div>
                        </div>
                        <!-- Card item END -->
                ...
                <div class="tiny-slider arrow-md-none arrow-bordered arrow-large arrow-round">
                    <div class="tiny-slider-inner" data-gutter="0" data-edge="50" data-autoplay="false" data-arrow="true" data-dots="false" data-items="1">
                        ...
                        <div class="item px-3 px-md-6">
                            ...
                            <div class="avatar"><img class="avatar-img rounded-circle" src="<?= base_url() ?>assets/images/avatar/01.jpg" alt="avatar"></div>
                        ...
                        <div class="item px-3 px-md-6">
                            <div class="position-absolute top-50 start-50 translate-middle display-1 text-body z-index-n9 opacity-1"><i class="fas fa-quote-left"></i></div>
                            <div class="avatar"><img class="avatar-img rounded-circle" src="<?= base_url() ?>assets/images/avatar/02.jpg" alt="avatar"></div>
                        ...
                        <div class="item px-3 px-md-6">
                            <div class="position-absolute top-50 start-50 translate-middle display-1 text-body z-index-n9 opacity-1"><i class="fas fa-quote-left"></i></div>
                            <div class="avatar"><img class="avatar-img rounded-circle" src="<?= base_url() ?>assets/images/avatar/03.jpg" alt="avatar"></div>
        ...
        <div class="row g-0 d-flex align-items-center">
            ...
            <div class="col-sm-6">
                <div class="text-center bg-primary-multiply position-relative overflow-hidden px-3 py-6 h-100">
                    ...
                    <img class="bg-primary-multiply position-absolute top-50 start-50 translate-middle z-index-n9" src="<?= base_url() ?>assets/images/about/05.jpg" alt="">
                </div>
            </div>
            <!-- Project Block -->
            <div class="col-sm-6">
