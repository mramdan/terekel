                    ...
                    <div class="tiny-slider-inner" data-arrow="false" data-dots="true" data-items-xl="3" data-items-lg="3" data-items-md="3" data-items-sm="2" data-items-xs="1">
                        ...
                        <div class="item">
                            <a href="#" class="card card-metro">
                                ...
                                <div class="card-image">
                                    <img src="<?= base_url() ?>assets/images/portfolio/01.jpg" alt="card image">
                                </div>
                                <!-- Card Overlay -->
                                <div class="card-img-overlay d-flex flex-column">
                                    <img class="w-40" src="<?= base_url() ?>assets/images/clients/light/01.svg" alt="">
                        ...
                        <div class="item">
                            <a href="#" class="card card-metro">
                                <!-- Card Image -->
                                <div class="card-image">
                                    <img src="<?= base_url() ?>assets/images/portfolio/02.jpg" alt="card image">
                                </div>
                                <!-- Card Overlay -->
                                <div class="card-img-overlay d-flex flex-column">
                                    <img class="w-40" src="<?= base_url() ?>assets/images/clients/light/02.svg" alt="">
                                    <div class="mt-auto card-text">
                        ...
                        <div class="item">
                            <a href="#" class="card card-metro">
                                <!-- Card Image -->
                                <div class="card-image">
                                    <img src="<?= base_url() ?>assets/images/portfolio/03.jpg" alt="card image">
                                </div>
                                <!-- Card Overlay -->
                                <div class="card-img-overlay d-flex flex-column">
                                    <img class="w-40" src="<?= base_url() ?>assets/images/clients/light/03.svg" alt="">
                                    <div class="mt-auto card-text">
                        ...
                        <div class="item">
                            <a href="#" class="card card-metro">
                                <!-- Card Image -->
                                <div class="card-image">
                                    <img src="<?= base_url() ?>assets/images/portfolio/04.jpg" alt="card image">
                                </div>
                                <!-- Card Overlay -->
                                <div class="card-img-overlay d-flex flex-column">
                                    <img class="w-40" src="<?= base_url() ?>assets/images/clients/light/04.svg" alt="">
                                    <div class="mt-auto card-text">
                        ...
                        <div class="item">
                            <a href="#" class="card card-metro">
                                <!-- Card Image -->
                                <div class="card-image">
                                    <img src="<?= base_url() ?>assets/images/portfolio/05.jpg" alt="card image">
                                </div>
                                <!-- Card Overlay -->
                                <div class="card-img-overlay d-flex flex-column">
                                    <img class="w-40" src="<?= base_url() ?>assets/images/clients/light/05.svg" alt="">
                                    <div class="mt-auto card-text">
                        ...
                        <div class="item">
                            <a href="#" class="card card-metro">
                                <!-- Card Image -->
                                <div class="card-image">
                                    <img src="<?= base_url() ?>assets/images/portfolio/06.jpg" alt="card image">
                                </div>
                                <!-- Card Overlay -->
                                <div class="card-img-overlay d-flex flex-column">
                                    <img class="w-40" src="<?= base_url() ?>assets/images/clients/light/06.svg" alt="">
                                    <div class="mt-auto card-text">
                        ...
                        <div class="item">
                            <a href="#" class="card card-metro">
                                <!-- Card Image -->
                                <div class="card-image">
                                    <img src="<?= base_url() ?>assets/images/portfolio/07.jpg" alt="card image">
                                </div>
                                <!-- Card Overlay -->
                                <div class="card-img-overlay d-flex flex-column">
                                    <img class="w-40" src="<?= base_url() ?>assets/images/clients/light/07.svg" alt="">
                                    <div class="mt-auto card-text">
        ...
        <div class="row">
            ...
            <div class="col-sm-12 col-md-4 mb-5">
                ...
                <div class="ps-6 pt-4 pt-sm-0">
                    ...
                    <img class="rounded" src="<?= base_url() ?>assets/images/about/01.jpg" alt="">
                </div>
            </div>
            <!-- Step item -->
            <div class="col-sm-6 col-md-4 mb-5">
                ...
                <div class="ps-6 pt-4 pt-sm-0">
                    ...
                    <img class="rounded" src="<?= base_url() ?>assets/images/about/02.jpg" alt="">
                </div>
            </div>
            <!-- Step item -->
            <div class="col-sm-6 col-md-4">
                ...
                <div class="ps-6 pt-4 pt-sm-0">
                    ...
                    <img class="rounded" src="<?= base_url() ?>assets/images/about/03.jpg" alt="">
                </div>
            </div>
        </div>
    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-6 col-sm-4 col-lg-3">
                        <div class="mb-4 p-4 grayscale bg-light-overlay-dotted text-center">
                            <img src="<?= base_url() ?>assets/images/clients/colored/01.svg" alt="">
                        </div>
                    </div>
                    <!-- Logo item -->
                    <div class="col-6 col-sm-4 col-lg-3">
                        <div class="mb-4 p-4 grayscale bg-light-overlay-dotted text-center">
                            <img src="<?= base_url() ?>assets/images/clients/colored/02.svg" alt="">
                        </div>
                    </div>
                    <!-- Logo item -->
                    <div class="col-6 col-sm-4 col-lg-3">
                        <div class="mb-4 p-4 grayscale bg-light-overlay-dotted text-center">
                            <img src="<?= base_url() ?>assets/images/clients/colored/03.svg" alt="">
                        </div>
                    </div>
                    <!-- Logo item -->
                    <div class="col-6 col-sm-4 col-lg-3">
                        <div class="mb-4 p-4 grayscale bg-light-overlay-dotted text-center">
                            <img src="<?= base_url() ?>assets/images/clients/colored/04.svg" alt="">
                        </div>
                    </div>
                    <!-- Logo item -->
                    <div class="col-6 col-sm-4 col-lg-3">
                        <div class="mb-4 p-4 grayscale bg-light-overlay-dotted text-center">
                            <img src="<?= base_url() ?>assets/images/clients/colored/05.svg" alt="">
                        </div>
                    </div>
                    <!-- Logo item -->
                    <div class="col-6 col-sm-4 col-lg-3">
                        <div class="mb-4 p-4 grayscale bg-light-overlay-dotted text-center">
                            <img src="<?= base_url() ?>assets/images/clients/colored/06.svg" alt="">
                        </div>
                    </div>
                    <!-- Logo item -->
                    <div class="col-6 col-sm-4 col-lg-3">
                        <div class="mb-4 p-4 grayscale bg-light-overlay-dotted text-center">
                            <img src="<?= base_url() ?>assets/images/clients/colored/07.svg" alt="">
                        </div>
                    </div>
                    <!-- Logo item -->
                    <div class="col-6 col-sm-4 col-lg-3">
                        <div class="mb-4 p-4 grayscale bg-light-overlay-dotted text-center">
                            <img src="<?= base_url() ?>assets/images/clients/colored/08.svg" alt="">
                        </div>
                    </div>
                    <!-- Logo item -->
                    <div class="col-6 col-sm-4 col-lg-3">
                        <div class="mb-4 p-4 grayscale bg-light-overlay-dotted text-center">
                            <img src="<?= base_url() ?>assets/images/clients/colored/09.svg" alt="">
                        </div>
                    </div>
                    <!-- Logo item -->
                    <div class="col-6 col-sm-4 col-lg-3">
                        <div class="mb-4 p-4 grayscale bg-light-overlay-dotted text-center">
                            <img src="<?= base_url() ?>assets/images/clients/colored/10.svg" alt="">
                        </div>
                    </div>
                    <!-- Logo item -->
                    <div class="col-6 col-sm-4 col-lg-3">
                        <div class="mb-4 p-4 grayscale bg-light-overlay-dotted text-center">
                            <img src="<?= base_url() ?>assets/images/clients/colored/11.svg" alt="">
                        </div>
                    </div>
                </div>
            </div>
